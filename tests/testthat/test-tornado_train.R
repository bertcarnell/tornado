...
test_that("tornado caret::train works", {
  ...
  g$plot <- g$plot + ggtitle("Test: caret::train randomforest")
  plot(g)
  ...
  g <- tornado(gtest, type = "PercentChange", alpha = 0.10, xlabel = "MPG")
  g$plot <- g$plot + ggtitle("Test:  caret::train randomforest PercentChange with factors")
  plot(g)

  g <- tornado(gtest, type = "percentiles", alpha = 0.10, xlabel = "MPG")
  g$plot <- g$plot + ggtitle("Test:  caret::train randomforest percentiles with factors")
  plot(g)

  g <- tornado(gtest, type = "ranges", alpha = 0.10, xlabel = "MPG")
  g$plot <- g$plot + ggtitle("Test:  caret::train randomforest ranges with factors")
  plot(g)
  ...
  g <- tornado(gtest, type = "PercentChange", alpha = 0.10, xlabel = "MPG")
  expect_equal(class(g$plot), c("gg","ggplot"))
  g$plot <- g$plot + ggtitle("Test: caret::train glmStepAIC")
  plot(g)
})
...
test_that("tornado caret::train works with classification", {
  ...
  expect_equal(class(g), "tornado_plot")
  expect_equal(class(g$plot), c("gg","ggplot"))
  g$plot <- g$plot + ggtitle("Test:  classifier caret::train randomforest PercentChange with factors")
  plot(g)
  ...
  expect_equal(class(g$plot), c("gg","ggplot"))
  g$plot <- g$plot + ggtitle("Test:  classifier caret::train randomforest percentiles with factors")
  plot(g)

  g <- tornado(gtest, type = "ranges", alpha = 0.10, xlabel = "Probability of Class 1", class_number = 1)
  expect_equal(class(g$plot), c("gg","ggplot"))
  g$plot <- g$plot + ggtitle("Test:  classifier caret::train randomforest ranges with factors")
  plot(g)
  ...
  expect_equal(class(g$plot), c("gg","ggplot"))
  g$plot <- g$plot + ggtitle("Test:  classifier caret::train randomforest ranges with factors - colors")
  plot(g)
  ...
  expect_equal(class(g$plot), c("gg","ggplot"))
  g$plot <- g$plot + ggtitle("Test:  classifier caret::train randomforest ranges with factors - bar width")
  plot(g)
  ...
  expect_equal(class(g$plot), c("gg","ggplot"))
  g$plot <- g$plot + ggtitle("Test:  classifier caret::train randomforest ranges with factors - points")
  plot(g)
})
